    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumo_inmueble_string', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fichero_prediccion_consumo_string', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fichero_precios_string', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            name='PrediccionMercadoRegulado',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(default='TPD', max_length=3)),
                ('costemr_actualizado', models.BooleanField(default=False)),
                ...
                ('modelo_tarifamr_origen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forecasting.ModeloMercadoRegulado')),
        ...
        migrations.AddField(
            model_name='modelomercadoregulado',
        ...
        migrations.AddField(
            model_name='modelomercadoregulado',
            name='tarifaMR_origen',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forecasting.TarifaMercadoRegulado'),
        ),
        migrations.CreateModel(
            name='CosteMRPrediccion',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ...
                ('prediccionconsumo_asociada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forecasting.PrediccionConsumo')),
                ('prediccionmr_asociada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forecasting.PrediccionMercadoRegulado')),
            ],
        ),
        migrations.CreateModel(
